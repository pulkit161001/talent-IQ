...
const SessionPage = () => {
	...
	useEffect(() => {
		...
		//refetch session data when new peer joins
		...
		<div className="h-screen bg-base-100 flex flex-col">
			...
			<div className="flex-1">
				<PanelGroup direction="horizontal">
					...
					<Panel defaultSize={50} minSize={30}>
						<PanelGroup direction="vertical">
											...
											<div className="flex items-center gap-3">
												...
												>
													{session?.difficulty.slice(0, 1).toUpperCase() +
														session?.difficulty.slice(1) || "unRated"}
												</span>
							...
							<Panel defaultSize={50} minSize={20}>
								<PanelGroup direction="vertical">
									{/* CODE PANEL */}
									{/* TODO: make code panel scrollable */}
					...
					<PanelResizeHandle className="w-2 bg-base-200 hover:bg-primary transition-colors cursor-row-resize" />
